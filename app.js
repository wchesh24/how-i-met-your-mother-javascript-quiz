...
function showScore() {
  ...
  if (scorePercentage > 90) {
    alert(
      "Congratulations! You are a HIMYM pro! You scored " +
        scorePercentage +
        "%!"
    );
  } else if (scorePercentage > 80) {
    alert(
      "Nice job! You must be a HIMYM enthusiast scoring " +
        scorePercentage +
        "%!"
    );
  } else if (scorePercentage > 70) {
    alert(
      "You know your stuff but maybe another run through will serve you well after scoring " +
        scorePercentage +
        "%!"
    );
    ...
    alert(
      "Ouch! You need to brush up on your episodes! You scored " +
        scorePercentage +
        "%!"
    );
  }
...
const myQuestions = [
  ...
  },
  {
    ...
    answers: [
      ...
      {
        text: "In order to move to San Francisco to pursue art",
        correct: true
      },
  ...
  {
    question:
      "In what other popular sitcom did the narrator of Ted play in during the 90's?",
    answers: [
  ...
  {
    question:
      "What was the name of the alter-ego popstar Robin Scherbatsky had in Canada?",
    answers: [
